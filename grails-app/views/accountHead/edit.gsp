...
<html>
	...
	<body>
		<a href="#edit-accountHead" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-accountHead" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:accountHeadInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${accountHeadInstance?.version}" />
				<fieldset class="form">
