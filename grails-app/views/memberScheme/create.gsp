...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'memberSchemecheme.label', default: 'memberSchemecheme')}"/>
...
<div id="create-user" class="content scaffold-create" role="main">
    ...
    <div class="dashIconWrap">
        ...
        <g:hasErrors bean="${memberScheme}">
            <ul class="errors" role="alert">
                <g:eachError bean="${memberScheme}" var="error">
        ...
        <div class="panel panel-default" style="padding: 10px;margin-right: 5px;">
            ...
            <g:form url="[resource: memberScheme, action: 'save']">
