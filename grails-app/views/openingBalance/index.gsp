                    ...
                    <thead>
                        <tr class="thead_tr">
                            ...
                            <th style="color: #ffffff"><g:message code="openingBalance.subCategory.label" default="Sub Category"/></th>
                                <g:sortableColumn property="debit" title="${message(code: 'openingBalance.debit.label', default: 'Is Debit?')}"/>
                                <g:sortableColumn property="openingBalance" title="${message(code: 'openingBalance.openingBalance.label', default: 'Opening Balance')}"/>
