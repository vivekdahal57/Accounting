...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'subCategory.label', default: 'Sub Category')}" />
    ...
    <div class="dashIconWrap">
        ...
        <g:hasErrors bean="${subCategory}">
            <ul class="errors" role="alert">
                <g:eachError bean="${subCategory}" var="error">
        ...
        <div class="panel panel-default" style="padding: 10px;margin-right: 5px;">
            ...
            <g:form url="[resource: subCategory, action: 'save']">
