		...
		<div id="list-subCategory" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="isIntrest" title="${message(code: 'subCategory.isIntrest.label', default: 'Is Intrest')}" />
					
						<g:sortableColumn property="name" title="${message(code: 'subCategory.name.label', default: 'Name')}" />
					
						<th><g:message code="subCategory.subAccountHead.label" default="Sub Account Head" /></th>
				...
				<g:each in="${subCategoryInstanceList}" status="i" var="subCategoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${subCategoryInstance.id}">${fieldValue(bean: subCategoryInstance, field: "isIntrest")}</g:link></td>
					
						<td>${fieldValue(bean: subCategoryInstance, field: "name")}</td>
					
						<td>${fieldValue(bean: subCategoryInstance, field: "subAccountHead")}</td>
