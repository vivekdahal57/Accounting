...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'interestRegulator.label', default: 'Interest Regulator')}"/>
...
<div id="create-user" class="content scaffold-create" role="main">
    ...
    <div class="dashIconWrap">
        ...
        <g:hasErrors bean="${interestRegulator}">
            <ul class="errors" role="alert">
                <g:eachError bean="${interestRegulator}" var="error">
        ...
        <div class="panel panel-default" style="padding: 10px;margin-right: 5px;">
            ...
            <g:form url="[resource:interestRegulator, action:'save']" >
                <fieldset class="form">
