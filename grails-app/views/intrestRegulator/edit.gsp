...
<html>
	...
	<body>
		<a href="#edit-intrestRegulator" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-intrestRegulator" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:intrestRegulatorInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${intrestRegulatorInstance?.version}" />
				<fieldset class="form">
