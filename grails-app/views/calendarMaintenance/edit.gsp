...
<html>
	...
	<body>
		<a href="#edit-calendarMaintenance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-calendarMaintenance" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:calendarMaintenanceInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${calendarMaintenanceInstance?.version}" />
				<fieldset class="form">
